...
class SnakeDemo extends StatefulWidget {
  const SnakeDemo({Key? key}) : super(key: key);

  @override
  _SnakeDemoState createState() => _SnakeDemoState();
}

class _SnakeDemoState extends State<SnakeDemo> {
